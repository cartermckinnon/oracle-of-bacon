...
public class MovieGraphNode{
	...
	public boolean equals(Object obj) {
		...
		if (myLinks == null) {
			if (other.myLinks != null)
				return false;
		} else if (!myLinks.equals(other.myLinks))
			return false;
		if (myMovie == null) {
			if (other.myMovie != null)
				return false;
		} else if (!myMovie.equals(other.myMovie))
			return false;
		return true;
	}
